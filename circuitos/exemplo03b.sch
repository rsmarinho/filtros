...
N 720 -230 720 -200 { lab=7}
N 570 -230 570 -200 { lab=#net2}
N 720 -140 720 -110 { lab=GND}
...
N 230 -230 270 -230 { lab=5}
N 720 -230 760 -230 { lab=7}
...
device=resistor
m=1}
C {devices/ind.sym} 230 -170 0 0 {name=L3
m=1
value=1n
footprint=1206
device=inductor}
...
device=resistor
m=1}
C {devices/ind.sym} 790 -230 3 0 {name=L4
m=1
value=1n
footprint=1206
device=inductor}
...
footprint=1206
device="ceramic capacitor"}
C {devices/ind.sym} 260 -510 3 0 {name=L1
m=1
value=1n
footprint=1206
device=inductor}
C {devices/ind.sym} 820 -450 0 0 {name=L2
m=1
value=1n
footprint=1206
device=inductor}
C {devices/capa.sym} 300 -230 3 0 {name=C3
m=1
value=1p
footprint=1206
device="ceramic capacitor"}
